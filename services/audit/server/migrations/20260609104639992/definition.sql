...
--
-- Class IdempotencyRecord as table sorvete_idempotency_cache
--
...
--
-- Class OutboxRecord as table sorvete_outbox
--
...
--
-- MIGRATION VERSION FOR audit
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('audit', '20260609104639992', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260609104639992', "timestamp" = now();
